...
<body>
	...
	<div class="interior-list">
		...
		<form action="listQuery" method="post">
			<div class="search-board">
				<select name="query">
					<option value="cname">-업체 이름-</option>
		...
		<c:if test="${login.lvl eq 1}">
			<p class="writebtn">
				<a class="btn"
					href="${pageContext.request.contextPath}/interior/newInteriorForm">업체등록하기</a>
			</p>
		</c:if>
		</div>
			...
			<ul>
				<li>
					...
					href='${pageContext.request.contextPath}/interior/readInterior?num=${interiorVO.num}'>
						<img
						src="${pageContext.request.contextPath}/board/fileDownload?filename=${interiorVO.filename}&downname=${interiorVO.realname}"
