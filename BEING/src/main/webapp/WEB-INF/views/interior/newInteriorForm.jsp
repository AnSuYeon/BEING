...
<div class =title>
	<p>업체명
		<input type="text" name="cname" value="${param.cname}"placeholder="업체명">
		<c:if test="${errors.cname}">업체명을 입력하세요.</c:if>
	</p>
</div>
<div class=introduce>
	<p>업체 소개
		<input type="text" name="introduce" rows="5" cols="30" value="${param.introduce}" placeholder="업체 소개을 입력하세요">
	</p>
</div>
