	...
	<div class="everthing">
		<div class="interior-img">
			<c:forEach var="listview" items="${listview}" varStatus="status">
					     <span >
							<img src ="${pageContext.request.contextPath}/board/fileDownload?filename=${listview.filename}&downname=${listview.realname}" width="300px" height="300px" style="border-radius: 7px;"> 							 
			...
			<div class="list">
				<td colspan="2">
					<c:set var="pageNo" value="${empty param.pageNo ? '1' : param.pageNo}" />
						<a class="btn" href="${pageContext.request.contextPath}/interior/listInterior">목록</a>
